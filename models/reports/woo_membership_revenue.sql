...
left join (select _customer_user, trial_take from dbt_marketing.transactions_dbt where trial_take is not null and post_status in ('wc-completed','wc-processing')) trials_table
