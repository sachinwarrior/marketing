(select user_tracking_id, 
  ...
  wc_last_active, 
  django_user, 
  cast(trial_date_start as date) as trial_date_start, 
  cast(_schedule_trial_end as date) as _schedule_trial_end, 
  cast(_schedule_cancelled as date) as _schedule_cancelled,        _schedule_next_payment, 
  billing_cycles,
  post_status, 
  full_order_id, 
